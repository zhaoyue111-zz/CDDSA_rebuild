...
from data.dataloader_bak import MultiDomainIterator
from torch.utils.tensorboard import SummaryWriter
from models.loss_bak import DomainStyleContrastiveLoss, StyleAugmentationLoss
...
class Trainer:
    def __init__(self, args):
        ...
        # 数据加载器
        self.train_loader = MultiDomainIterator(
            root_dir=args.data_dir,
            domain_list=args.train_domain,
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.args.epoches):
            ...
            print(f"学习率: ae={self.scheduler_ae.get_last_lr()[0]:.6f}, "
                  f"style={self.scheduler_style.get_last_lr()[0]:.6f}")
            print(f"未改善轮数: {self.epochs_without_improvement}")
